...
&lt;/template&gt;</code></pre>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            <div class="border border-gray-200 dark:border-neutral-700 rounded-lg p-6">
                ...
                <ul class="list-disc pl-5 space-y-2">
                    ...
                    <li>Pair icons with text labels for better clarity, especially for actions that might be ambiguous.</li>
                    <li>Use consistent icons throughout your application to build user familiarity.</li>
                    <li>Consider using icons to save space in compact UI elements like toolbars or mobile interfaces.</li>
                </ul>
            </div>
            <div class="border border-gray-200 dark:border-neutral-700 rounded-lg p-6">
                ...
                <ul class="list-disc pl-5 space-y-2">
                    ...
                    <li>Consider using larger icon sizes for touch targets on mobile devices (at least 44×44px).</li>
                </ul>
            </div>
        </div>
        ...
        <p>
            Below is a complete list of all available icons in the library. Clicking on an icon will copy its implementation code to your clipboard, making it easy to integrate into your project. Use the search field to filter icons by name.
        </p>
        ...
        <div class="mb-6 mt-4">
            <div class="relative">
                <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                    <svg class="w-5 h-5 text-gray-500 dark:text-neutral-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <p v-if="filteredIcons.length === 0 && searchQuery" class="mt-2 text-sm text-gray-500 dark:text-neutral-400">
        ...
        <div v-if="filteredIcons.length > 0" class="text-sm text-gray-500 dark:text-neutral-400 mt-4 text-center">
        ...
        <p>
            The following brand icons are available for use in your application. These icons are particularly useful for social media links, login options, or displaying technology stacks.
        </p>

        <!-- Search field for brand icons -->
        <div class="mb-6 mt-4">
            <div class="relative">
                <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                    <svg class="w-5 h-5 text-gray-500 dark:text-neutral-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <p v-if="filteredBrandIcons.length === 0 && searchBrandQuery" class="mt-2 text-sm text-gray-500 dark:text-neutral-400">
        ...
        <div v-if="filteredBrandIcons.length > 0" class="text-sm text-gray-500 dark:text-neutral-400 mt-4 text-center">
