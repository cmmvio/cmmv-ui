<template>
    <BaseLayout>
        ...
        <p>The <code>CButton</code> component offers different sizes to adapt to various interface contexts. Below are examples of the five available sizes.</p>
...
&lt;/c-button&gt;</code></pre>
        ...
        <p>
            The <code>CButton</code> component supports a variety of style <code>variants</code>, making it highly adaptable to different design requirements. Each variant is defined through the variant property, which allows you to choose the visual style of the button. For example, the "elevated" variant adds a subtle shadow to give the button a sense of depth, making it stand out on the page. The "outlined" variant applies a clear border around the button, creating a clean, lightweight look without a filled background. On the other hand, the "flat" variant removes all shadows and borders, focusing purely on background and text colors for a minimalist appearance.
        </p>

        <p>For layouts with a lot of content or subtle interactions, the "text" style provides a button that looks like a simple text link, seamlessly integrating with its surroundings. Similarly, the "plain" variant ensures a very clean, unobtrusive button with a transparent background that highlights the internal content. The combination of these variants with custom properties like <code>bgColor</code> and <code>textColor</code> offers endless styling possibilities.</p>
        ...
        <table-docs>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="border-b px-4 py-2">
                        Makes the button highly subtle by removing the background and reducing opacity, which increases on hover.
                    </td>
                </tr>
            </tbody>
        </table-docs>
...
&lt;c-button size="2xl" type="button"&gt;Double Extra Large&lt;/c-button&gt;</code></pre>
        ...
        <p>The <code>CButton</code> also supports customizing its border radius using the <code>rounded</code> property. This property allows you to define the button's appearance, ranging from sharp corners to fully rounded edges. The available options are <code>none</code>, <code>default</code>, <code>md</code>, and <code>full</code>.</p>
