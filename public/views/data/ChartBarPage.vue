<template>
    <BaseLayout>
        ...
        <p>
            The <code>CChartBar (alias: c-chart-bar)</code> component allows you to create interactive and responsive
            bar
            charts,
        ...
        <p>
            The following example demonstrates the basic usage of the <code>CChartBar</code> component with a single
            data
            series.
        </p>
  ...
  &lt;/script&gt;</code></pre>
        ...
        <p>
            You can customize the X and Y axes of the chart, adding titles, changing the grid, and configuring the
            ticks.
        </p>
  ...
  &lt;/script&gt;</code></pre>
        ...
        <card-docs>
            <div class="mb-4">
                <c-chart-bar :data="basicChartData" title="Interactive Chart" height="300px"
                    @chart-click="handleChartClick" @chart-hover="handleChartHover" />
                <div v-if="selectedBar" class="mt-2 p-2 border rounded">
                    <strong>Selected bar:</strong> &#123;&#123; selectedBar.label &#125;&#125; - &#123;&#123;
                    selectedBar.value
                    &#125;&#125;
                </div>
            </div>
