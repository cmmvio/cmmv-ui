<template>
  <BaseLayout>
    ...
    <p>The <code>CDatepicker (alias: c-datepicker)</code> component allows users to select a date through an interactive calendar. It supports custom formatting, minimum and maximum dates, validation, and interaction states.</p>
    ...
    <table-docs>
      ...
      <tbody>
        <tr>
          ...
          <td class="border-b px-4 py-2">The selected date or date range, bound using <code>v-model</code>. For range selection, it's an array of dates.</td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td class="border-b px-4 py-2">Boolean</td>
          <td class="border-b px-4 py-2">false</td>
          <td class="border-b px-4 py-2">Enables date range selection mode, allowing selection of start and end dates.</td>
        </tr>
      </tbody>
    </table-docs>
    ...
    <p>
        The <code>CDatepicker</code> component provides a user-friendly date selection interface with a calendar dropdown.
...
&lt;/script&gt;</code></pre>
    ...
    <p>
        The <code>CDatepicker</code> component supports selecting a date range, such as for travel bookings with departure and return dates.
