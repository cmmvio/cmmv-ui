...
&lt;/template&gt;
        ...
        <p>
            The <code>indeterminate</code> prop allows the checkbox to be displayed in an indeterminate state. This is useful for multi-selection scenarios where only some options are selected, such as in hierarchical lists or "select all" implementations.
        </p>
...
&lt;/template&gt;
        ...
        <p>
            The <code>disabled</code> prop can be used to disable the checkbox, making it non-interactive. This is useful for scenarios where the checkbox state should not be modified by the user, such as in forms with conditional fields or when displaying read-only information.
        </p>
...
&lt;/template&gt;
        ...
        <p>
            The <code>CCheckbox</code> supports color customization to align with your application's design. Use the <code>bgColor</code>, <code>borderColor</code>, and <code>textColor</code> props to style the checkbox with any desired color theme. Below are examples of checkboxes with different color combinations.
        </p>
...
&lt;/template&gt;
        ...
        <p>
            The <code>CCheckbox</code> supports array-based bindings for managing multiple selections. Using the <code>v-model</code> directive with an array allows you to bind multiple checkboxes to a single model, making it easy to manage grouped options. This is particularly useful for forms with multiple choice selections or filter interfaces.
        </p>

        <card-docs>
            <div class="mx-auto px-4 py-5 sm:p-6">
                <div class="flex flex-col justify-start space-y-4 sm:flex-row sm:items-end sm:justify-around sm:space-y-0 sm:space-x-4">
                ...
                <div class="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700 text-center text-gray-600 dark:text-gray-300">
