        ...
        <table class="w-full text-left border-collapse border-0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="border-b px-4 py-2">Text label displayed next to the toggle.</td>
                </tr>
                <tr>
                    <td class="border-b px-4 py-2">disabled</td>
                    <td class="border-b px-4 py-2">Boolean</td>
                    <td class="border-b px-4 py-2">false</td>
                    <td class="border-b px-4 py-2">Disables the toggle and prevents user interaction.</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="border-b px-4 py-2">Custom color for the thumb (toggle button).</td>
                </tr>
                <tr>
                    <td class="border-b px-4 py-2">trackColor</td>
                    <td class="border-b px-4 py-2">String</td>
                    <td class="border-b px-4 py-2">"bg-blue-600"</td>
...
&lt;/template&gt;</code>
        ...
        <c-card class="mx-auto mt-4 px-4 py-5 sm:p-6 flex flex-col items-center space-y-4">
            <c-toggle v-model="toggleCustom1" label="Custom Blue Track" trackColor="bg-blue-800" thumbColor="bg-blue-500" />
            <c-toggle v-model="toggleCustom2" label="Custom Red Track" trackColor="bg-red-800" thumbColor="bg-red-500" />
            <c-toggle v-model="toggleCustom3" label="Custom Thumb" trackColor="bg-purple-800" thumbColor="bg-purple-500" />
        </c-card>
