<template>
    <c-card
        variant="flat"
        class="mx-auto px-3 py-4 sm:p-6 flex flex-col center"
    >
        ...
        <span class="mb-0">By subscribing, you agree with <a href="/terms-of-service">Terms of Service</a> and <a href="/privacy-policy">Privacy Policy</a>.</span>
    </c-card>
</template>
