<template>
    <svg xmlns="http://www.w3.org/2000/svg" id="flag-icons-io" viewBox="0 0 640 480">
        ...
        <path fill="#000063" fill-rule="evenodd"
        ...
        <path fill="#a24300" fill-rule="evenodd" stroke="#fff" stroke-width="2.1"
            d="m474.8 131.7-3.5 329c0 17.3 15.7 17.3 17.4 0l-3.5-329Z" />
        <path fill="#006d00" fill-rule="evenodd" stroke="#fff" stroke-width="1.8"
        ...
        <path fill="#006d00" fill-rule="evenodd" stroke="#fff" stroke-width="2"
        ...
        <path fill="#006d00" fill-rule="evenodd" stroke="#fff" stroke-width="1.9"
        ...
        <g fill-rule="evenodd">
            <path fill="#c00" stroke="#000" stroke-width="1pt"
            ...
            <g stroke="#000" stroke-width="1pt">
                ...
                <path fill="#fff" d="M478.4 549.2a17.8 17.8 0 1 1-35.5 0 17.8 17.8 0 0 1 35.5 0z"
            ...
            <path fill="#fff" stroke="#000" stroke-width="1pt"
            ...
            <path fill="#fff100" stroke="#000" stroke-width="1pt"
                d="M531.5 584.6s-68-52-69.8-177.1c-1-72 34.4-124 123-124 124 0 301.1 53.1 301.1 53.1v17.7s-141.7-53.1-301.2-53.1c-70.8 0-106.3 52-106.3 105.2 0 88.6 71 178.3 71 178.3v141.7h-17.8z"
                transform="matrix(.12934 0 0 .11906 367.5 257.6)" />
            <path fill="#fff100" stroke="#000" stroke-width="3"
            ...
            <path fill="#fff100" stroke="#000" stroke-width="1pt"
                ...
                transform="matrix(.12934 0 0 .11906 367.5 257.6)" />
            <path fill="#fff100" stroke="#000" stroke-width="1pt" d="M708.7 832.7v-124S815 744 815 832.7z"
            ...
            <path fill="#fff100" stroke="#000" stroke-width="2.2"
            ...
            <path fill="#fff100" stroke="#000" stroke-width="3.3"
            ...
            <path fill="#fff100" stroke="#000" stroke-width="1pt" d="M850.4 655.5h70.9v53.2h-71z"
                transform="matrix(.12934 0 0 .11906 367.5 215.5)" />
            <path fill="#fff100" stroke="#000" stroke-width="1pt" d="M850.4 683.3h70.9v202.5h-71z"
                transform="matrix(.12934 0 0 .11906 367.5 215.5)" />
            <path fill="#fff" stroke="#000" stroke-width="1pt"
                d="M478.4 549.2a17.8 17.8 0 1 1-35.5 0 17.8 17.8 0 0 1 35.5 0z"
