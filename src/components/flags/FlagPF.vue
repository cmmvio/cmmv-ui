<template>
    <svg xmlns="http://www.w3.org/2000/svg" id="flag-icons-pf" viewBox="0 0 640 480">
        ...
        <g clip-path="url(#pf-a)">
            ...
            <path fill="#083d9c" fill-rule="evenodd" stroke="#083d9c" stroke-width="2pt"
            ...
            <path fill="red" fill-rule="evenodd" stroke="#000" stroke-linejoin="round" stroke-width="2.5"
                d="m301.3 218.9 38.4 10.2v-54.8c-17.6 1-32.2-33.4-1.2-35.7-30.5-4.4-34 3.5-37.5 12z" />
            <path fill="#083d9c" fill-rule="evenodd" stroke="#083d9c" stroke-linecap="round" stroke-width="5"
                d="m277 258.7 86.7.3" />
            <path fill="none" stroke="#000" stroke-linecap="round" stroke-width="4"
            ...
            <path fill="#ef7d08" fill-rule="evenodd"
