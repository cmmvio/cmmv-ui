<template>
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="flag-icons-vg"
        viewBox="0 0 640 480">
        <defs>
            <linearGradient id="vg-a" x1="103.1" x2="92.6" y1="111.3" y2="107.8"
                gradientTransform="matrix(.99614 0 0 2.25255 703.8 -75)" gradientUnits="userSpaceOnUse">
        ...
        <g transform="translate(-217.5 -9.4)scale(.77497)">
            ...
            <path fill="#006129" stroke="#000" stroke-width="1.9"
            ...
            <g fill="#ffc6b5" stroke="#000" stroke-width=".9">
                ...
                <g fill="none">
                    ...
                    <path stroke-linejoin="round" stroke-width="1.7"
