            ...
            <transition name="fade">
                <div v-if="isOpen" class="absolute flex items-center z-50 bottom-12 ml-0.5" :class="menuOrientation">
                    <button
                        ...
                        :title="action.label"
                        class="flex justify-center items-center w-[52px] h-[52px] text-gray-500 hover:text-gray-900 bg-white rounded-full border border-neutral-200 shadow-md dark:border-neutral-600 dark:text-neutral-100 dark:bg-neutral-700 dark:hover:bg-neutral-600 hover:bg-neutral-50 focus:ring-4 focus:outline-none focus:ring-neutral-300 dark:focus:ring-neutral-400"
                    >
            ...
            <transition name="fade">
                <div v-if="isOpen" class="absolute flex items-center z-50" :class="menuOrientation">
                    <button
                        ...
                        @click="emit('select', action)"
                        :title="action.label"
                        class="flex justify-center mb-3 items-center w-[52px] h-[52px] text-gray-500 hover:text-gray-900 bg-white rounded-full border border-neutral-200 shadow-md dark:border-neutral-600 dark:text-neutral-100 dark:bg-neutral-700 dark:hover:bg-neutral-600 hover:bg-neutral-50 focus:ring-4 focus:outline-none focus:ring-neutral-300 dark:focus:ring-neutral-400"
                    >
                        <component :is="action.icon" class="w-5 h-5 dark:text-neutral-300 hover:dark:text-white" />
                        <span class="sr-only">{{ action.label }}</span>
                    </button>
